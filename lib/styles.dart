...
class Styles {
  ...
  static Color primaryColor = Color.fromRGBO(250, 112, 53, 1);
  ...
  static final accanceColor = Color.fromRGBO(17, 122, 139, 1);
  ...
  static TextStyle formTitle = baloo.copyWith(color: Styles.primaryColor, height: 1, fontSize: 20, letterSpacing: 0.22, fontWeight: FontWeight.w700);
